...
public class DBStatement{
    ...
    private DBStatement(){
        try {
            ...
            String mySqlUrl = "jdbc:mysql://localhost:3306/car?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&useOldAliasMetadataBehavior=true";
            String username = "KKys";
            String password = "ysysycyc";
