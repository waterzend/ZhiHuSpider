...
public class DBStatement {
    ...
    private DBStatement(){
        try {
            ...
            String mySqlUrl = "jdbc:mysql://localhost:3306/zhihu?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&useOldAliasMetadataBehavior=true";
